    ...
    fetch(urlPoke)
      ...
      .then((data) => {
        ...
        document.getElementById(
          "maqueta"
        ).innerHTML = `<div class="col-4 row d-flex align-content-center justify-content-center">
        ...
        fetch(especie)
          ...
          .then(function (deta) {
            ...
            document.getElementById(
              "japones"
            ).innerText = `Nombre en japonés: ${nombreJapones}`;
            document.getElementById(
              "habitat"
            ).innerHTML = `Habitat: ${habitacion}`;
            document.getElementById(
              "crecimiento"
            ).innerHTML = `Tasa de crecimiento: ${crecimiento}`;
            document.getElementById(
              "generacion"
            ).innerHTML = `Generación: ${generacion}`;
